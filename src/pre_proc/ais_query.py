...
def query_ais_duckdb(
    ...
    parquet dataset generated by `save_by_mmsi` (partitioned by MMSI, Date).
    ...
    verbose : bool, optional
        If True, prints the generated SQL query and a short summary.
    ...
    if verbose:
        print("[ais_query] Querying parquet files from:", root_path, " from date", date_start, " to date ", date_end)
    ...
    if verbose:
        ...
        print(f"[ais_query] {row_count:,} rows, {vessel_part}, from date {date_start} to date {date_end}")
