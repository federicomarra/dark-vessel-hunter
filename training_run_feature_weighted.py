...
from src.train.training_loop_weighted import run_experiment
...
def training_run():
    ...
    PARQUET_FILE = "ais-data/df_preprocessed/pre_processed_df_train_20min_12h_split_10months.parquet"
    TRAIN_OUTPUT_DIR = "models/real_weighted3_20min_12h_split_10months"
    ...
    # DEFINE WEIGHTS: 
    # [Lat, Lon, SOG, Sin, Cos]
    # Here we give 3x importance to Lat/Lon compared to Speed/Course
    FEATURE_WEIGHTS = [3.0, 3.0, 1.0, 1.0, 1.0] 
    ...
    param_grid = {
        ...
        'latent_dim': [64],         # Bottleneck: 16 (Anomaly Detection) vs 64 (Reconstruction)
        'num_layers': [1],           # Depth
        'lr': [0.001],          # Learning Rate
        'feature_weights': [FEATURE_WEIGHTS],  # Feature Weights
